			...
			<div class="containerBox boxIndex">
				<div class="rn-box check-box" style="display: block;">
					<form id="form-addprofile">
						<div class="frm">
							<div class="frm-hd">
							    <?php if ($this->_var['btn']['parent_id'] > 0): ?>
							...
							<div class="frm-nav">
											...
											<div class="section-bd">
												...
												<div class="group frm-control-group extra" id="sort_order_group">
													...
													<div class="frm-controls">
														<input type="text" class="frm-controlM" placeholder="" id="sort_order" name="sort_order" value="<?php echo $this->_var['btn']['sort_order']; ?>">
												...
												<div class="group frm-control-group extra" id="name_group">
													...
													<div class="frm-controls">
														<input type="text" class="frm-controlM" placeholder="" id="btn_name" name="btn_name" value="<?php echo $this->_var['btn']['btn_name']; ?>">
												...
												<div class="group frm-control-group extra" id="btn_type_group">
													...
													<div class="frm-controls">
														<select class="frm-controlM"  id="btn_type" name="btn_type">
														   <option value="1" <?php if ($this->_var['btn']['btn_type'] == 1): ?> selected <?php endif; ?>>触发关键词</option>
														   <option value="2" <?php if ($this->_var['btn']['btn_type'] == 2): ?> selected <?php endif; ?>>跳转网址</option>
														</select>
												...
												<div class="group frm-control-group extra" id="keyword_group">
													...
													<div class="frm-controls">
														<input type="text" class="frm-controlM" placeholder="" id="keyword" name="keyword" value="<?php echo $this->_var['btn']['keyword']; ?>">
												...
												<div class="group frm-control-group extra" id="url_group">
													...
													<div class="frm-controls">
														<input type="text" class="frm-controlM" placeholder="" id="url" name="url" value="<?php echo $this->_var['btn']['url']; ?>">
								...
								<div class="frm-ft">
									<div class="frm-opr"> <a class="btnGreen" id="form-submit" href="javascript:;">编辑提交</a>
										<input type="hidden" name="id" value="<?php echo $this->_var['btn']['id']; ?>" />
