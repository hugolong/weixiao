...
class WX_Remote_Opera{
	...
	private function get_access_token($appid,$appsecret){
		    //https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx659ecc805f987bac&secret=da3bb34cc373fd0c4921b414c08eddef
		$url="https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=".$appid."&secret=".$appsecret;
		$arr=curl_https($url);//$arr = json_decode(file_get_contents($url),1);
		//$arr = json_decode(fopen_url($url),1);arr($arr);
        return $arr;
	}
